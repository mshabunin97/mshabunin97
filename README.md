...
Я начинающий веб разработчик<img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30px">. Мой путь в IT начался с января 2023 года. Я пробовал себя в нескольких направлениях: изучал Python, разбирался в Qa, но больше всего меня зацепила веб разработка! В этом направлении сейчас активно развиваюсь. Основной фокус моего обучения был на языках программирования HTML, CSS и JavaScript. Также я освоил популярную  библиотеку, такую как React. Ознакомиться с моими проектами можно в разделе "Pinned" ниже. Там я закрепил несколько из  личных проектов, которые демонстрируют мои навыки в веб-разработке.
<br>
